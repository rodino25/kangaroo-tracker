    ...
    <div class="row">
      <div class="col col-lg-4 offset-lg-4 col-md-6 offset-md-3">
        <div class="h2 mt-5 text-center">
          <a class="text-info" href="<?php echo e(url('/')); ?>"><?php echo e(env("app_name")); ?></a>
        </div>
...
</section><?php /**PATH C:\xampp\htdocs\kangaroo-tracker\resources\views/auth/login.blade.php ENDPATH**/ ?>